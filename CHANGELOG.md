...
## [1.16.2](https://github.com/neonlabsorg/aave-v3-core/compare/v1.19.4...v1.16.2) (2024-08-13)


### Features

* Add additional compressed pool interactions ([690d1ab](https://github.com/neonlabsorg/aave-v3-core/commit/690d1ab2f7c81f04bc797bd67bccbf1a50edbf04))
* add additional flashloan scenario ([8888093](https://github.com/neonlabsorg/aave-v3-core/commit/88880936a353d3dd5c9556d0fabb3f15ecd01c0c))
* add OpenZeppelin SafeERC20 and Address dependencies ([#859](https://github.com/neonlabsorg/aave-v3-core/issues/859)) ([493bb4d](https://github.com/neonlabsorg/aave-v3-core/commit/493bb4dfd3e0a69f7c3fbf468bc8ef310da9960b))
* add owner constructor parameter to contracts that inherits Ownable to support CREATE2 factory deployment ([b6cc245](https://github.com/neonlabsorg/aave-v3-core/commit/b6cc245b7e78e7d27b7af3e045cceff58e477231))
* Add rescueTokens functionality for Pool and AToken ([047edf8](https://github.com/neonlabsorg/aave-v3-core/commit/047edf8a3cbb93d2d61f25b7954be9599ee96fd7))
* add tests, fixed supply, supplyWithPermit decode ([0ab5099](https://github.com/neonlabsorg/aave-v3-core/commit/0ab5099ba80b1c16b49410afeaa6037eb3989bba))
* add unit test for reserve configuration ([49d0f4e](https://github.com/neonlabsorg/aave-v3-core/commit/49d0f4e6baa5b78d31443617456331904db7dfdc))
* Add zero IR strategy ([#818](https://github.com/neonlabsorg/aave-v3-core/issues/818)) ([ade6cf8](https://github.com/neonlabsorg/aave-v3-core/commit/ade6cf86f296ee68e82077ca18a3218096516862))
* added check on setSiloedBorrowing ([ab5be8e](https://github.com/neonlabsorg/aave-v3-core/commit/ab5be8ebb183610d1bbee44a745dc93452341abd))
* added method ([e2cf96c](https://github.com/neonlabsorg/aave-v3-core/commit/e2cf96c7b8b8c8f2d867b5538767ba8661733735))
* bump @aave/deploy-v3 ([430c9d3](https://github.com/neonlabsorg/aave-v3-core/commit/430c9d3eebfafc6349ead5860016e25ff43fb547))
* bump @aave/deploy-v3 version ([85ec0fe](https://github.com/neonlabsorg/aave-v3-core/commit/85ec0fe7cb45ae227b74ceb53c9088612034a3dc))
* bump beta deploy package ([fbcf885](https://github.com/neonlabsorg/aave-v3-core/commit/fbcf885269285b36b54cc741da7922d257255a44))
* bump ci node.js to 16 ([82a11d2](https://github.com/neonlabsorg/aave-v3-core/commit/82a11d2f4b7a2b747def6a5bfe1a52fd5a30a9ee))
* bump to beta version ([348ce20](https://github.com/neonlabsorg/aave-v3-core/commit/348ce204a7b30a9846dbe9637b17e86125137d6f))
* clean dependencies and upgrade child dependencies ([7ca97ca](https://github.com/neonlabsorg/aave-v3-core/commit/7ca97ca4cd6e9aad74583a4a1ca5ebe3fae44c64))
* enable and disable flashloans ([bb62572](https://github.com/neonlabsorg/aave-v3-core/commit/bb625723211944a7325b505caf6199edf4b8ed2a))
* initial commit ([19a37e3](https://github.com/neonlabsorg/aave-v3-core/commit/19a37e32183e23009439d032eccb756fbd03d1cc))
* initial implementation ([5f0da40](https://github.com/neonlabsorg/aave-v3-core/commit/5f0da40fc1d74d7c6f72ac8344e392ea6b8810f2))
* refactored executeLiquidationCall function ([63e43ef](https://github.com/neonlabsorg/aave-v3-core/commit/63e43eff1c36a8d7e96c86f9655e7af31fe7e81f))
* remove borrow enabled requirement ([8b9221b](https://github.com/neonlabsorg/aave-v3-core/commit/8b9221b822c0ecf1cc84831b51d4137072dc28d3))
* removed obsolete files for the certora tools ([d7e0e7c](https://github.com/neonlabsorg/aave-v3-core/commit/d7e0e7c37c0741b54afde3354d0be4a619fafde5))
* set to hardhat 2.10.0 and ethers to 5.6.9 ([9b50898](https://github.com/neonlabsorg/aave-v3-core/commit/9b50898f6dbace6c2228e4bd41c081ff4afa7324))
* switch bit used for flashloan enabled ([748818f](https://github.com/neonlabsorg/aave-v3-core/commit/748818f0ef78c94fc45192165cbb3a24c23d63d9))
* updated price oracle sentinel interface ([0457e71](https://github.com/neonlabsorg/aave-v3-core/commit/0457e7176c89f91700e0aa63691dd0d9580b77db))
* updated price oracle sentinel interface ([f6b71f5](https://github.com/neonlabsorg/aave-v3-core/commit/f6b71f508db2a9a6f966bc6d606198eebaaefbb9))
* updates and tests ([8d12d79](https://github.com/neonlabsorg/aave-v3-core/commit/8d12d798cee82ab2d2b210c35a9ca69089b5ded3))


### Bug Fixes

* `reserves` renamed to `reservesData` or `reservesList` when fitting ([3a6b928](https://github.com/neonlabsorg/aave-v3-core/commit/3a6b928abb9ad6920582064704673e84f4b543dd))
* Add BUSL to tokenization contracts ([#784](https://github.com/neonlabsorg/aave-v3-core/issues/784)) ([bf87c52](https://github.com/neonlabsorg/aave-v3-core/commit/bf87c52825ac1d8847e870bfe238b702b2cdf7b8))
* add comment for undocumentted parameter ([ba0e4ee](https://github.com/neonlabsorg/aave-v3-core/commit/ba0e4ee72cc3060fc55294aeac0a7bbb9caf3087))
* Add getter for `_stableRateExcessOffset` ([3586ebb](https://github.com/neonlabsorg/aave-v3-core/commit/3586ebbe2df893332c791ad9aa1bf049240d8c25))
* Add helpers for proxy contracts (eip1967 slots) ([d82be43](https://github.com/neonlabsorg/aave-v3-core/commit/d82be4350d1778c269b5f7d875bdf5025fcff0bd))
* Add IL2Pool interface with comment + inheritdoc in L2Pool ([c077b30](https://github.com/neonlabsorg/aave-v3-core/commit/c077b303760c74480d82a27db100092ebf9fb38c))
* Add license to L2Pool contract ([#765](https://github.com/neonlabsorg/aave-v3-core/issues/765)) ([56fd7ba](https://github.com/neonlabsorg/aave-v3-core/commit/56fd7ba792e084518c2852cc6158f214cfd3eb2e))
* Add missing natspec + repay with aToken ([af1f7d7](https://github.com/neonlabsorg/aave-v3-core/commit/af1f7d7220e118ddc330c2678fa77aac91b25f7a))
* add more validation to set emode params ([383bde5](https://github.com/neonlabsorg/aave-v3-core/commit/383bde5f8f246acd574c89da009f9a2436a37bc8))
* Add natspec [@dev](https://github.com/dev) for new flow ([b07e852](https://github.com/neonlabsorg/aave-v3-core/commit/b07e852d39adfc3c43a68cdd602aba0913e78a39))
* Add natspec and handle naming ([1f5c8a9](https://github.com/neonlabsorg/aave-v3-core/commit/1f5c8a9daeeb58e25049d315127c37b3b92cee74))
* add natspec docs to flags of reserve configuration map ([#854](https://github.com/neonlabsorg/aave-v3-core/issues/854)) ([792c23e](https://github.com/neonlabsorg/aave-v3-core/commit/792c23eed73d3791fde31f6d26c69bc62f3533bf))
* add owner parameters to test suites ([6e96821](https://github.com/neonlabsorg/aave-v3-core/commit/6e968212d088ab6c9911b85dc454e4b989db7d6f))
* add validation to simpleFlashLoan ([bf652c2](https://github.com/neonlabsorg/aave-v3-core/commit/bf652c2837d1403977e9cbc50e623dee21c5fcf4))
* Add virtual to getReserveNormalizedIncome function ([bc10fd2](https://github.com/neonlabsorg/aave-v3-core/commit/bc10fd24750680e83e3d4abb54bf452998fa0e0d))
* Adding literal params struct to initReserve ([43cced7](https://github.com/neonlabsorg/aave-v3-core/commit/43cced7b155fa8cd714f5a088f5bf0b24ba6dc4e))
* Avoid emitting events when balanceIncrease is zero ([#745](https://github.com/neonlabsorg/aave-v3-core/issues/745)) ([43f34c9](https://github.com/neonlabsorg/aave-v3-core/commit/43f34c90400d02f3959beeec21038464d924242a))
* Bump version of v3 dependencies ([#938](https://github.com/neonlabsorg/aave-v3-core/issues/938)) ([64870f0](https://github.com/neonlabsorg/aave-v3-core/commit/64870f00345c8e10eefd6057bdba66f14ea0682c))
* Capitalize license name of contracts ([fba69f0](https://github.com/neonlabsorg/aave-v3-core/commit/fba69f087131abcb5945f6e817d5c7acb51badfa))
* CEI to fix reentrancy risk with reentrant tokens (eg ERC777) ([#704](https://github.com/neonlabsorg/aave-v3-core/issues/704)) ([7fbdc6e](https://github.com/neonlabsorg/aave-v3-core/commit/7fbdc6ea5f657072fbdf9494db07f1769c38c1d9))
* Change function modifier of MAX_NUMBER_RESERVES to pure ([dc34a67](https://github.com/neonlabsorg/aave-v3-core/commit/dc34a67d390e66ce77622d0c8ce80edd572fe9c6))
* check revert msg and event emission ([284b492](https://github.com/neonlabsorg/aave-v3-core/commit/284b49221e1947f689fd63da7c845f6b9c641f8b))
* Cleanup naming and remove duplicate tests ([6ed5891](https://github.com/neonlabsorg/aave-v3-core/commit/6ed589163ae30b235206dc571b98091f08dc5bad))
* communicate correct premium in case of debt-bearing flashloan ([#822](https://github.com/neonlabsorg/aave-v3-core/issues/822)) ([7b2a284](https://github.com/neonlabsorg/aave-v3-core/commit/7b2a2840e1bc7e1201fd4ed37cbbd8da967dda11))
* Complete interfaces of IReserveInterestRateStrategy and IPoolDataProvider ([#766](https://github.com/neonlabsorg/aave-v3-core/issues/766)) ([a00dda8](https://github.com/neonlabsorg/aave-v3-core/commit/a00dda8faf464f6b0d338cf7e902e5931e0edbea))
* Consistently use `from` when burning. ([a5fa434](https://github.com/neonlabsorg/aave-v3-core/commit/a5fa43426764ec4348c15169d1479283d5c55e1d))
* dependencies ([f844a45](https://github.com/neonlabsorg/aave-v3-core/commit/f844a4596b22fd16ec2516fa1e72c6d223481710))
* Enforce restrictions on stableRateBorrowingEnabled flag ([5d9938d](https://github.com/neonlabsorg/aave-v3-core/commit/5d9938d32645b89192127a74a4915fbbe247e7b2))
* Error library ([475eb1d](https://github.com/neonlabsorg/aave-v3-core/commit/475eb1d73755d1ab8eb997feb0ebfa7f15f9893a))
* expose error list and types at npm package ([#809](https://github.com/neonlabsorg/aave-v3-core/issues/809)) ([0334bf2](https://github.com/neonlabsorg/aave-v3-core/commit/0334bf2d3452aaca256a4855ea9b3c04c74dfe8a))
* Fix collateral behavior of zero-ltv assets ([#820](https://github.com/neonlabsorg/aave-v3-core/issues/820)) ([ea48670](https://github.com/neonlabsorg/aave-v3-core/commit/ea4867086d39f094303916e72e180f99d8149fd5))
* fix comments ([b90b888](https://github.com/neonlabsorg/aave-v3-core/commit/b90b888726beed2032b6c0ba84d797cf90aef2e5))
* Fix condition of full liquidation of collateral ([#753](https://github.com/neonlabsorg/aave-v3-core/issues/753)) ([56bcf5d](https://github.com/neonlabsorg/aave-v3-core/commit/56bcf5d1ef378e9e5e7d09bcdb0bc42b4a1b645d))
* Fix constant definition for readability ([2d4ce6b](https://github.com/neonlabsorg/aave-v3-core/commit/2d4ce6bce2f280302472add66e6d78b703875a9a))
* Fix contract docstrings ([802a4bd](https://github.com/neonlabsorg/aave-v3-core/commit/802a4bd428edeff446cf0fca2696f4f7ad2a97cd))
* Fix docs param in burnScaled ([6b504d4](https://github.com/neonlabsorg/aave-v3-core/commit/6b504d4bced83e1ac64ab552d082387de042e5af))
* Fix docstrings of ISequencerOracle ([4391fd4](https://github.com/neonlabsorg/aave-v3-core/commit/4391fd4c8f29fb81c966fd4510df89d0acdb8404))
* Fix event checks in test cases ([#824](https://github.com/neonlabsorg/aave-v3-core/issues/824)) ([29ff9b9](https://github.com/neonlabsorg/aave-v3-core/commit/29ff9b9f89af7cd8255231bc5faf26c3ce0fb7ce))
* Fix imports order ([5d237a4](https://github.com/neonlabsorg/aave-v3-core/commit/5d237a4e7e4259b28a50052ba106961a38911220))
* Fix missing `!=0` to `&gt;0` ([58cf7d7](https://github.com/neonlabsorg/aave-v3-core/commit/58cf7d779bd532a51e71fcaabd0994e4e7f03c63))
* Fix param of IAToken function ([1cb9ba1](https://github.com/neonlabsorg/aave-v3-core/commit/1cb9ba198650c8582e12657c0ac9b21fa379ff06))
* Fix prepublish step in CI ([#862](https://github.com/neonlabsorg/aave-v3-core/issues/862)) ([ec2902a](https://github.com/neonlabsorg/aave-v3-core/commit/ec2902a4a113c6584434d49742ee1a5616070f90))
* Fix test of inaccuracy when liquidationProtocolFee is on ([7d8b7bf](https://github.com/neonlabsorg/aave-v3-core/commit/7d8b7bf5acf016e541beaa36e2e82783ff74b846))
* Fix ts type of contract in tests ([12373ca](https://github.com/neonlabsorg/aave-v3-core/commit/12373ca09d4e2cec32546dc87285d516c1d9f261))
* Fix typo in docs ([#752](https://github.com/neonlabsorg/aave-v3-core/issues/752)) ([9ccb1ab](https://github.com/neonlabsorg/aave-v3-core/commit/9ccb1ab3c175d1e71404e875e623f1d161fd17e7))
* Fix typo in package contributors tag ([14a3b6d](https://github.com/neonlabsorg/aave-v3-core/commit/14a3b6d503d71d080c145e7fbcdacbe68b2b11ba))
* fix typos ([5f623aa](https://github.com/neonlabsorg/aave-v3-core/commit/5f623aa41bf1605e4af08ef7897694e287155f0c))
* Fix typos ([#781](https://github.com/neonlabsorg/aave-v3-core/issues/781)) ([8a39136](https://github.com/neonlabsorg/aave-v3-core/commit/8a3913607df88afcc4b8cc63f3a876ebac7d148b))
* Fix typos on techpaper ([#950](https://github.com/neonlabsorg/aave-v3-core/issues/950)) ([682e86c](https://github.com/neonlabsorg/aave-v3-core/commit/682e86c72db644f6992c22f97b0f5ec313ed1f5b))
* fixed condition in validateBorrow ([a810aba](https://github.com/neonlabsorg/aave-v3-core/commit/a810abafa7eed7256326cd708a6a3bca2570dc64))
* fixed issue after merge ([715c6e0](https://github.com/neonlabsorg/aave-v3-core/commit/715c6e0c1001de546a4b51d430978647edcf3345))
* Fixes solc version of contracts ([#920](https://github.com/neonlabsorg/aave-v3-core/issues/920)) ([6d6fa53](https://github.com/neonlabsorg/aave-v3-core/commit/6d6fa53d360b43f492ff5b3c7033f95aee4f1335))
* Handle minor merge conflict ([8a715e7](https://github.com/neonlabsorg/aave-v3-core/commit/8a715e77b290132c329d5658cb6e7e37ea06e264))
* import updated deploy package and fix token upgrade functions ([1d409d6](https://github.com/neonlabsorg/aave-v3-core/commit/1d409d61cbbbfad14e03f90d7ca7c05345ba826a))
* Improve consistency of function naming of CalldataLogic ([1a5517d](https://github.com/neonlabsorg/aave-v3-core/commit/1a5517d28b531d673e6ac81e59b552d1280e7d7e))
* Install the last package of periphery for the rewards contract update ([066259a](https://github.com/neonlabsorg/aave-v3-core/commit/066259a79444b097da911021d120e1fe4a000ad6))
* issue fix - breaks v3-deploy ([9c476a9](https://github.com/neonlabsorg/aave-v3-core/commit/9c476a950f6d6428d102012c413085ec2d1d89de))
* Linebreak to reduce keep line length &lt; 120. ([1ca5e38](https://github.com/neonlabsorg/aave-v3-core/commit/1ca5e38c19c4bf1e86434884563662d9eab352da))
* linting ([#837](https://github.com/neonlabsorg/aave-v3-core/issues/837)) ([97cb6ea](https://github.com/neonlabsorg/aave-v3-core/commit/97cb6ead76ed69dbeae144a47f4dbef807f06082))
* load market test data correctly, fix atoken/debt token names ([72d1264](https://github.com/neonlabsorg/aave-v3-core/commit/72d1264d1e6a285663828e37c52b9078525ca291))
* make InterestRateStrategy contract inheritable ([d06f8f2](https://github.com/neonlabsorg/aave-v3-core/commit/d06f8f22296f44673b15f2b71df8d17a70b1ea88))
* make InterestRateStrategy contract inheritable ([0311475](https://github.com/neonlabsorg/aave-v3-core/commit/0311475614ed7a6c4befba99a7567ee27454f942))
* Make transferOnLiq() virtual ([6968062](https://github.com/neonlabsorg/aave-v3-core/commit/6968062ba1129b0e88ddb60408d235329a913fc9))
* Mark all functions as virtual ([f6932b3](https://github.com/neonlabsorg/aave-v3-core/commit/f6932b3d8c0055caf4ed1a191ec64676f4e68ad1))
* Minimize the IAaveIncentivesController with only the handleAction ([a33f931](https://github.com/neonlabsorg/aave-v3-core/commit/a33f93119f53d01c69b9c65a20d552e19a175e76))
* mintToTreasurey call _mintScaled directly ([c422ac8](https://github.com/neonlabsorg/aave-v3-core/commit/c422ac8d945f41d55115996cb0bd257e73c700de))
* missing library at test, add updated deploy beta package ([67a5c80](https://github.com/neonlabsorg/aave-v3-core/commit/67a5c80f04d0bcdd2dfa01c4b2d18a8a82dd222e))
* modify interface versions to support all minor 0.8.x vers ([9e95439](https://github.com/neonlabsorg/aave-v3-core/commit/9e954393ea6c50aa00318e7f96a5867d0f49a460))
* Move `dropReserve` logic to PoolLogic ([169d72c](https://github.com/neonlabsorg/aave-v3-core/commit/169d72c58135b49b1236fd7fe9478adf1053efe9))
* Move `initReserve` and `getReservesList` to PoolLogic ([b0ef5e4](https://github.com/neonlabsorg/aave-v3-core/commit/b0ef5e4ed8ff4aa2d1a872f23899a1e81476b6ba))
* Move availableLiqudity assignment in DefaultReserveInterestRateStrategy ([8c82d9d](https://github.com/neonlabsorg/aave-v3-core/commit/8c82d9d87566ec2bacb705e2918ebb6e916d13b6))
* Move comment up in validationlogic ([cbdaa30](https://github.com/neonlabsorg/aave-v3-core/commit/cbdaa3080f43ea53bcc4afa9636735eff1deb175))
* Move getters back to Pool, rename execute for functions called by pool ([106b617](https://github.com/neonlabsorg/aave-v3-core/commit/106b6174c40086347de907f17dbf65f7535d69f3))
* Move reservesData param to the beginning of the param list ([0872cb4](https://github.com/neonlabsorg/aave-v3-core/commit/0872cb4c30e79566f09a0320168d0bd1f5111a29))
* Moved getUserAccountData logic to PoolLogic to minimize contract size ([b07bdab](https://github.com/neonlabsorg/aave-v3-core/commit/b07bdab921705788f38e130f75a10a1444cbc6b1))
* Naming `Atoken` to `AToken` in LiquidationLogic ([7ff9858](https://github.com/neonlabsorg/aave-v3-core/commit/7ff9858decd1e714171fc2f4c90cc01f92c366ba))
* Naming Atoken to AToken ([0d50841](https://github.com/neonlabsorg/aave-v3-core/commit/0d508413f9ddba280ff32db6898d3927f1219bda))
* Natspec for `IPool::swapBorrowRateMode()` ([5b016fc](https://github.com/neonlabsorg/aave-v3-core/commit/5b016fc699ef816204cf1e0fe1178285f53cf83c))
* Optimize logic for atoken self-transfers ([6c3154e](https://github.com/neonlabsorg/aave-v3-core/commit/6c3154eedb5e543bd564953058c40b7f19b42d41))
* Place interface extension declaration at the end ([19c015e](https://github.com/neonlabsorg/aave-v3-core/commit/19c015ec76efc229da6b59fafa9f640d56e7f157))
* Place interface extension declaration at the end of L2Pool definition ([93f2b85](https://github.com/neonlabsorg/aave-v3-core/commit/93f2b85ad92622ad99dfbd9e1f0e3c4abe88eef1))
* Re-add the abstract modifier to base tokenization contracts ([52abb3f](https://github.com/neonlabsorg/aave-v3-core/commit/52abb3f81a420ed233422d7caee87beda8e8f31e))
* reentrancy in liquidationCall ([cd508a7](https://github.com/neonlabsorg/aave-v3-core/commit/cd508a713d3cdd4e09c514fe0c47cf8f51383b07))
* refactor calldata minifier for L2 gas optimization ([ac37b45](https://github.com/neonlabsorg/aave-v3-core/commit/ac37b45901341a3cc935cb07b4fa3af155f44eb4))
* Reformat code ([84b900c](https://github.com/neonlabsorg/aave-v3-core/commit/84b900ce583eb8b1174357c05882e4a9f1854c38))
* Remove blank space ([0c208fa](https://github.com/neonlabsorg/aave-v3-core/commit/0c208fa3555c481667fa507ebfec1863a9bc39f9))
* Remove FLASHLOAN_PREMIUMS_MISMATCH error and update error values ([4c2a884](https://github.com/neonlabsorg/aave-v3-core/commit/4c2a884c7d993c9230eb5ef9a4fb7ef3a8a21d52))
* remove formatting conflicts ([4c2cda0](https://github.com/neonlabsorg/aave-v3-core/commit/4c2cda0f63326d986a7a7e68da32f9570623a450))
* remove gitignore update ([d7aa26a](https://github.com/neonlabsorg/aave-v3-core/commit/d7aa26af60d2b9f34c95316fe42c17f51115630b))
* remove initial config of fee params in pool initialize function ([#846](https://github.com/neonlabsorg/aave-v3-core/issues/846)) ([3bb960b](https://github.com/neonlabsorg/aave-v3-core/commit/3bb960b92bcb3d58d8bdcd2d2f924340ba812164))
* remove npm ci cache, bump gas reporter to fixed version 1.0.8 set ethers to fixed version 5.6.1 ([bbb2dfd](https://github.com/neonlabsorg/aave-v3-core/commit/bbb2dfde6c754c4e0552e78f43c5c09a6474805f))
* Remove rescueTokensFromAToken from Pool ([1a32301](https://github.com/neonlabsorg/aave-v3-core/commit/1a32301881993888b880e077236de90493338cde))
* Remove SafeCast in Pool and add use of uint128 for flashloan premiums ([ba50cc7](https://github.com/neonlabsorg/aave-v3-core/commit/ba50cc703be80d899d73fd2d4c8ebba23eb56070))
* Remove SafeCast in Pool and user uin128 for flashloan premiums ([fff3f9a](https://github.com/neonlabsorg/aave-v3-core/commit/fff3f9afa2a0bfb985855304839f0eb8d99b62eb))
* Remove toEModeCategory field in FinalizeTransferParams ([cb404aa](https://github.com/neonlabsorg/aave-v3-core/commit/cb404aa6e946c2176bb0f4ddf53443fd6cd18edd))
* Remove unnecessary parameter to `executeMintUnbacked()` ([71714c4](https://github.com/neonlabsorg/aave-v3-core/commit/71714c474c55f612462b60b5b223af37f5ea13d3))
* Remove unneeded comment ([1cb2324](https://github.com/neonlabsorg/aave-v3-core/commit/1cb2324e11138c08d908d8cda7460f8598005cd1))
* Remove unneeded comment ([4134d89](https://github.com/neonlabsorg/aave-v3-core/commit/4134d89707e5dec310fcb1f6945d1692d7a9cf5c))
* Remove unneeded currentLiquidationThreshold field from ValidateBorrowLocalVars struct ([fd0d117](https://github.com/neonlabsorg/aave-v3-core/commit/fd0d1178b1debaae3dd7f8810ca650a6b7a43ddc))
* Remove unneeded debtToken field from FlashLoanLocalVars struct ([0cab344](https://github.com/neonlabsorg/aave-v3-core/commit/0cab3445e3132ef3b751c6d2c3dc830a340136ef))
* Remove unneeded fields in FlashLoanLocalVars struct ([9cb3a05](https://github.com/neonlabsorg/aave-v3-core/commit/9cb3a05efdcb388ff7329480f26de8b3cc38d249))
* Remove unneeded import of interface in Pool ([cc49160](https://github.com/neonlabsorg/aave-v3-core/commit/cc4916049d394fbadf63568b3ddaef74b531d087))
* Remove unneeded underlyingAssetName field from InitReserveInput struct ([2dd66b8](https://github.com/neonlabsorg/aave-v3-core/commit/2dd66b8086beb0fedae9c438dec89733ad4c9b32))
* remove unrelated change ([a5ce86a](https://github.com/neonlabsorg/aave-v3-core/commit/a5ce86a350f428e4a89bd0867254c7a898c72ca3))
* Remove unused import from `Calldatalogic` ([ba8ab4a](https://github.com/neonlabsorg/aave-v3-core/commit/ba8ab4a5a911d45f662129dafd019b0973c51a43))
* removed shift on borrowing mask ([53fd36d](https://github.com/neonlabsorg/aave-v3-core/commit/53fd36d2ad958f83faf5ecb9379ff240224c02a3))
* removed using ([fd36278](https://github.com/neonlabsorg/aave-v3-core/commit/fd36278cf4ea03583d5fb1796f4ecc539e1c4d7e))
* Rename flashloanRepayment internal funciton to _flashloanRepayment ([3e18b8a](https://github.com/neonlabsorg/aave-v3-core/commit/3e18b8ad2a80776f47f72c6c9bb5dfe620400e82))
* Rename reserves to reservesList ([4b0af0b](https://github.com/neonlabsorg/aave-v3-core/commit/4b0af0bbb200e76dfedc7adf923c80e74fae37cb))
* Replace &gt; 0 with != 0 ([7bc9926](https://github.com/neonlabsorg/aave-v3-core/commit/7bc99264a76453f04ac7754595ec643317b0763e))
* Replace `...PriceAddress` with `...PriceSource` ([10a8667](https://github.com/neonlabsorg/aave-v3-core/commit/10a8667b08c2e3daa1d87b1a7348154081c3903d))
* replace with correct npm package name ([3d2d9fb](https://github.com/neonlabsorg/aave-v3-core/commit/3d2d9fb65b609412fd39ef9b75795ee62a183882))
* Return final withdraw amount in L2Pool withdraw fn ([#831](https://github.com/neonlabsorg/aave-v3-core/issues/831)) ([37b4d1f](https://github.com/neonlabsorg/aave-v3-core/commit/37b4d1f0e770ccb9ebdf50037c81582f3c79c5ee))
* Return real backing amount when backUnbacked ([526a1e6](https://github.com/neonlabsorg/aave-v3-core/commit/526a1e6965c00c7fbac41578bcc139404f751c5b))
* Revert chainId renaming ([c4283d5](https://github.com/neonlabsorg/aave-v3-core/commit/c4283d5fe062c4af5a6c37effa95df67efd7bd57))
* Revert dependencies to last working state ([ff4d987](https://github.com/neonlabsorg/aave-v3-core/commit/ff4d98765cea9b07f3e61f5b5e0efc472a06addc))
* Revision numbers and visibility ([1f35e76](https://github.com/neonlabsorg/aave-v3-core/commit/1f35e769f111e374ad66b58e40028b05ca75e81c))
* Simplify `executeRepay` ([6ab4a44](https://github.com/neonlabsorg/aave-v3-core/commit/6ab4a44d601c71784a3af47d0d3f2c1d0f09b3f4))
* Soften solidity version of FlashLoanBase contracts ([#861](https://github.com/neonlabsorg/aave-v3-core/issues/861)) ([364a779](https://github.com/neonlabsorg/aave-v3-core/commit/364a779efd9a7e42ec1882156d95a62f22ea3fc4))
* solution to fix liquidation failed case. ([623730b](https://github.com/neonlabsorg/aave-v3-core/commit/623730b3db4146281a11c5424938d339c4005357))
* streamline test ([516e0e8](https://github.com/neonlabsorg/aave-v3-core/commit/516e0e81263b2133c8640836ffa08afb112aacfa))
* typo ([#717](https://github.com/neonlabsorg/aave-v3-core/issues/717)) ([9666e99](https://github.com/neonlabsorg/aave-v3-core/commit/9666e9912c956950e6a4682df5e381999411840b))
* typo in tech paper ([d6b9cbc](https://github.com/neonlabsorg/aave-v3-core/commit/d6b9cbc55adf88c4cb7dd6df11941167fd119b3d))
* typos ([#715](https://github.com/neonlabsorg/aave-v3-core/issues/715)) ([7dd869f](https://github.com/neonlabsorg/aave-v3-core/commit/7dd869f68bbdb07ac94cf671bdf93c392c65af60))
* uint256 for decoded deadline + natspec to calldatalogic ([6002d6f](https://github.com/neonlabsorg/aave-v3-core/commit/6002d6f9da1cd501385aaa32a5af02771d0dbb3a))
* undo removed spaces ([a631f80](https://github.com/neonlabsorg/aave-v3-core/commit/a631f80763778c3935c3d0b5f2222076fcff4c0d))
* Update comment ([94c4cfb](https://github.com/neonlabsorg/aave-v3-core/commit/94c4cfbd95d45e772d6348bdcde7e212a5651ea6))
* update comment for setReserveFlashLoaning ([9d84549](https://github.com/neonlabsorg/aave-v3-core/commit/9d84549a0a1e91246da0312068a59e37413f5aa8))
* update comments ([5f09cf9](https://github.com/neonlabsorg/aave-v3-core/commit/5f09cf90792d1e8aa71168de4822f4f4b29da0a8))
* Update contributors etc in package.json ([60fc967](https://github.com/neonlabsorg/aave-v3-core/commit/60fc967fa8037bb856c0c39c1e433fabafab255c))
* update deploy and periphery dependencies ([078fa28](https://github.com/neonlabsorg/aave-v3-core/commit/078fa28584484209a0a1fac44cbc6ae827b719f6))
* Update deploy version ([a99e5b4](https://github.com/neonlabsorg/aave-v3-core/commit/a99e5b458e4264ec1b583d7bbeafc12fde9a0ba5))
* Update gas optimization numbers ([8719929](https://github.com/neonlabsorg/aave-v3-core/commit/8719929597742e697cd8824cd29d9a786f3ec0eb))
* update hardhat dependencies and fix test-suite error codes ([#739](https://github.com/neonlabsorg/aave-v3-core/issues/739)) ([a54692a](https://github.com/neonlabsorg/aave-v3-core/commit/a54692a54eddf2c0d5531de86ae298c491a2b192))
* Update import order in PoolLogic ([40447cd](https://github.com/neonlabsorg/aave-v3-core/commit/40447cd10c1925ce5daea74f0d201c571128cab6))
* Update natspec ([f60a451](https://github.com/neonlabsorg/aave-v3-core/commit/f60a451508f8c96a6c9dad55a2f5b43812feb721))
* Update natspec and test ([39363e4](https://github.com/neonlabsorg/aave-v3-core/commit/39363e4dd659899163619b62ef4fd2818a58f620))
* Update natspec for `calculateInterestRates()` ([b22150b](https://github.com/neonlabsorg/aave-v3-core/commit/b22150b8da8ba0a51845264e367b1935456b0ba7))
* Update ordering in `FlashLoanRepaymentParams` ([93dd9ea](https://github.com/neonlabsorg/aave-v3-core/commit/93dd9eadd3f8e0deef5b91ff36f038d14b89e8f6))
* Update test name ([f6319b9](https://github.com/neonlabsorg/aave-v3-core/commit/f6319b94d0db7a65ca7763115b29845f78dd5ae4))
* update use of virtual ([f652adf](https://github.com/neonlabsorg/aave-v3-core/commit/f652adfc38b7bf75c32afbfb404f220694f5a669))
* Update validationlogic constant value formatting ([d6ff0b2](https://github.com/neonlabsorg/aave-v3-core/commit/d6ff0b209ca9a15644cf517d2ac2a158dffbe71a))
* upgrade periphery and deploy library to latest version ([902b48a](https://github.com/neonlabsorg/aave-v3-core/commit/902b48aca1b53435fb302c0ba462c79beb1b57b8))
* Use `&gt; 0` consistently over `!= 0` ([f40538c](https://github.com/neonlabsorg/aave-v3-core/commit/f40538c2e07076d6179ca73369f82d13726332e1))
* Use `EModeLogic::isInEModeCategory` in `executeLiquidationCall` ([28f72fe](https://github.com/neonlabsorg/aave-v3-core/commit/28f72fe82496044d23d4ea3f20298cec9918404b))
* use ethers 5.5.3 to prevent different @ethersproject/bignumber version ([5411930](https://github.com/neonlabsorg/aave-v3-core/commit/541193012dfd3c7ee1cb0dc2dfc11db091876145))
* Use memory instead of storage in `getLiquidationBonus` ([deccf52](https://github.com/neonlabsorg/aave-v3-core/commit/deccf529ad8d300f8a0e768cc8d9bf6d48b7699f))


### Miscellaneous Chores

* release 1.10.0 ([734f83a](https://github.com/neonlabsorg/aave-v3-core/commit/734f83abe0385760489185aa7fb7e773a41ab8b8))
* release 1.16.2 ([32901d1](https://github.com/neonlabsorg/aave-v3-core/commit/32901d1e541b38e2273ae896c43323a02a2ed744))
